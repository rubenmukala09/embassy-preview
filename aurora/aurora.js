...
(function () {
  ...
  const SUBNAV = {
    ...
    "consular-services.html": {
      ...
      items: [
        ["Passports", "passport.html", "Apply for or renew your biometric passport"],
        ["Visas", "visa.html", "Entry visas for travel to the DRC"],
        ["Tenant-Lieu", "laissez-passer.html", "Emergency travel document (laissez-passer)"],
        ["Legalization", "legalization.html", "Authenticate documents and signatures"],
  ...
  if (searchToggle) {
    ...
    const INDEX = [
      ...
      { t: "Passports & renewal", tf: "Passeports et renouvellement", d: "Apply for or renew a biometric passport", df: "Demander ou renouveler un passeport biométrique", u: "passport.html", k: "passport renew renewal biometric expired passeport renouveler renouvellement biometrique expire" },
      { t: "Visas", tf: "Visas", d: "Entry visas for travel to the DRC, types and fees", df: "Visas d'entrée pour voyager en RDC, types et frais", u: "visa.html", k: "visa entry travel visa entree voyage tourisme" },
      { t: "Tenant-Lieu (travel document)", tf: "Tenant-Lieu (document de voyage)", d: "Emergency one-way laissez-passer", df: "Laissez-passer d'urgence, aller simple", u: "laissez-passer.html", k: "laissez passer emergency travel document laissez-passer document de voyage urgence aller simple" },
      { t: "Document legalization", tf: "Légalisation de documents", d: "Authenticate and certify documents", df: "Authentifier et certifier des documents", u: "legalization.html", k: "legalize notarize authenticate certify legalisation legaliser authentifier certifier notarier procuration" },
      ...
      { t: "Lost or stolen passport", tf: "Passeport perdu ou volé", d: "What to do, police report and travel document", df: "Que faire, déclaration de police et document de voyage", u: "laissez-passer.html", k: "lost stolen passport police report replace perdu vole passeport declaration police remplacer" },
      ...
      { t: "Yellow fever and health", tf: "Fièvre jaune et santé", d: "Vaccination requirement for travel to the DRC", df: "Vaccination obligatoire pour voyager en RDC", u: "visa.html", k: "yellow fever vaccination health certificate fievre jaune vaccin sante carnet" },
  ...
  (function assistant() {
    ...
    const KB = [
      { k: ["passport","passeport","renew","renouvel","biometric","biometrique","new passport","nouveau passeport","expired","expire"], a: "<b>Passports</b> are biometric and issued by Kinshasa. Three steps: 1) pre-register and pay <b>US$75</b> at passeport.gouv.cd (after obtaining an NIF tax ID), 2) email your documents to the consulate, 3) attend a biometric appointment. Processing takes about 90 days. <a href='passport.html'>Full process &rarr;</a>", af: "Les <b>passeports</b> sont biométriques et délivrés par Kinshasa. Trois étapes : 1) pré-enregistrement et paiement de <b>75 US$</b> sur passeport.gouv.cd (après l'obtention d'un NIF), 2) envoi de vos documents au consulat, 3) rendez-vous biométrique. Délai : environ 90 jours. <a href='passport.html'>Procédure complète &rarr;</a>" },
      { k: ["minor","child","children","kid","baby","enfant","mineur","bebe","passport","passeport"], a: "For a <b>minor's passport</b>, also bring the original birth certificate, a legalized parental authorization and a parent's passport. <a href='passport.html'>Details &rarr;</a>", af: "Pour un <b>passeport de mineur</b>, ajoutez l'acte de naissance original, une autorisation parentale légalisée et le passeport d'un parent. <a href='passport.html'>Détails &rarr;</a>" },
      { k: ["lost","stolen","perdu","vole","perte","police report","declaration de police","passport","passeport"], a: "If your passport is <b>lost or stolen</b>, file a police report and bring it to your appointment. You may also apply for a <b>Tenant-Lieu</b> travel document to return home. For emergencies call <a href='tel:+12022347690'>+1 (202) 234-7690</a>. <a href='laissez-passer.html'>Travel document &rarr;</a>", af: "En cas de <b>passeport perdu ou volé</b>, faites une déclaration de police et apportez-la à votre rendez-vous. Vous pouvez aussi demander un <b>Tenant-Lieu</b> pour rentrer. Urgences : <a href='tel:+12022347690'>+1 (202) 234-7690</a>. <a href='laissez-passer.html'>Document de voyage &rarr;</a>" },
      { k: ["how long","processing","delay","status","track","when ready","combien de temps","delai","suivi","statut","pret"], a: "Processing expectations vary by service and begin only after a complete application is accepted. Confirm the current estimate with the Consular Section before making travel plans. <a href='consular-services.html#status'>Status guidance &rarr;</a>", af: "Les délais varient selon le service et ne commencent qu’après l’acceptation d’un dossier complet. Confirmez l’estimation actuelle auprès de la Section consulaire avant d’organiser votre voyage. <a href='consular-services.html#status'>Guide de suivi &rarr;</a>" },
      { k: ["visa","visas","tourist","touriste","entry","entree"], a: "<b>Visas</b> for the DRC range from <b>$45</b> (transit) to <b>$450</b> (6-month multiple entry). You need a valid passport, a photo, a yellow-fever card and a return envelope. <a href='visa.html'>Types &amp; fees &rarr;</a>", af: "Les <b>visas</b> pour la RDC vont de <b>45$</b> (transit) à <b>450$</b> (6 mois, entrées multiples). Il faut un passeport valide, une photo, un carnet de fièvre jaune et une enveloppe de retour. <a href='visa.html'>Types et frais &rarr;</a>" },
      { k: ["yellow fever","vaccination","vaccine","fievre jaune","vaccin","requirements","conditions","invitation","documents"], a: "For a DRC visa you generally need a passport valid 6+ months, one photo, proof of <b>yellow-fever vaccination</b>, and for some categories an invitation or hotel booking. <a href='visa.html'>Requirements &rarr;</a>", af: "Pour un visa RDC il faut généralement un passeport valide 6 mois, une photo, une preuve de vaccination contre la <b>fièvre jaune</b>, et pour certaines catégories une invitation ou une réservation d'hôtel. <a href='visa.html'>Conditions &rarr;</a>" },
      { k: ["student","study","university","school","etudiant","etudes","universite","ecole"], a: "For a <b>student visa</b>, add an admission letter and proof of funds to the standard requirements. <a href='visa.html'>Visa services &rarr;</a>", af: "Pour un <b>visa étudiant</b>, ajoutez une lettre d'admission et une preuve de ressources aux conditions habituelles. <a href='visa.html'>Services de visa &rarr;</a>" },
      ...
      { k: ["legal","legaliz","legalis","apostille","authenticat","authentif","notar","power of attorney","procuration","certify","certif"], a: "We <b>legalize and authenticate</b> documents and perform notarial acts, including powers of attorney. Bring the original and valid ID. The DRC is not in the Apostille Convention, so consular legalization applies. <a href='legalization.html'>Legalization &rarr;</a>", af: "Nous <b>légalisons et authentifions</b> les documents et réalisons des actes notariés, dont les procurations. Apportez l'original et une pièce d'identité. La RDC n'étant pas partie à la Convention Apostille, la légalisation consulaire s'applique. <a href='legalization.html'>Légalisation &rarr;</a>" },
      { k: ["tenant","laissez","laissez-passer","travel document","document de voyage"], a: "A <b>Tenant-Lieu</b> (laissez-passer) is a one-way travel document for citizens who cannot obtain a passport in time. <a href='laissez-passer.html'>Tenant-Lieu &rarr;</a>", af: "Le <b>Tenant-Lieu</b> (laissez-passer) est un document de voyage aller simple pour les citoyens qui ne peuvent obtenir un passeport à temps. <a href='laissez-passer.html'>Tenant-Lieu &rarr;</a>" },
      ...
      { k: ["nif","tax id","numero fiscal","identifiant fiscal","impot"], a: "A <b>NIF</b> (tax identification number) is required before pre-registering for a passport at passeport.gouv.cd. <a href='passport.html'>Passport steps &rarr;</a>", af: "Un <b>NIF</b> (numéro d'identification fiscale) est requis avant le pré-enregistrement du passeport sur passeport.gouv.cd. <a href='passport.html'>Étapes du passeport &rarr;</a>" },
      ...
      { k: ["translation","translate","traduction","traduire","interpreter"], a: "For official use, a document in another language may need a <b>certified translation</b>. We can advise and, where applicable, legalize the translation. <a href='legalization.html'>Legalization &rarr;</a>", af: "Pour un usage officiel, un document dans une autre langue peut nécessiter une <b>traduction certifiée</b>. Nous pouvons vous conseiller et, le cas échéant, légaliser la traduction. <a href='legalization.html'>Légalisation &rarr;</a>" },
      ...
      { k: ["health","sante","medical","malaria","paludisme","insurance","assurance"], a: "Travellers to the DRC need proof of <b>yellow-fever vaccination</b>; malaria prophylaxis and travel insurance are strongly recommended. <a href='visa.html'>Travel requirements &rarr;</a>", af: "Les voyageurs vers la RDC doivent présenter une preuve de vaccination contre la <b>fièvre jaune</b> ; un traitement antipaludéen et une assurance voyage sont vivement recommandés. <a href='visa.html'>Conditions de voyage &rarr;</a>" },
...
(function () {
  ...
  var FR = {
    ...
    "Review the Appointment Guidance page before visiting. Online booking is not connected in this preview. Confirm the current procedure with the Consular Section so you know whether your service is handled in person or by mail.": "Consultez la page Informations sur les rendez-vous avant votre visite. La prise de rendez-vous en ligne n’est pas connectée dans cet aperçu. Confirmez la procédure actuelle auprès de la Section consulaire afin de savoir si votre service est traité en personne ou par courrier.",
    "Processing expectations depend on the service, identity checks, document completeness and production requirements. Confirm the current estimate with the Consular Section before making travel plans. Timing begins only after a complete application is accepted.": "Les délais dépendent du service, des vérifications d’identité, de la complétude du dossier et des exigences de production. Confirmez l’estimation actuelle auprès de la Section consulaire avant d’organiser votre voyage. Le délai ne commence qu’après l’acceptation d’un dossier complet.",
    ...
    // -- Hero --
    "Serving Congolese citizens and strengthening partnerships between the DRC and the United States.": "Au service des citoyens congolais et du renforcement des partenariats entre la RDC et les États-Unis.",
    "Consular services": "Services consulaires",
    ...
    "The Embassy in Washington, D.C. serves Congolese nationals across all 50 U.S. states & territories.": "L’Ambassade à Washington, D.C. sert les ressortissants congolais dans les 50 États & territoires des États-Unis.",
    "+39 more": "+39 autres",
    ...
    // -- Footer --
    "Embassy of the Democratic Republic of the Congo, serving Congolese citizens and strengthening DRC–U.S. partnership.": "Ambassade de la République démocratique du Congo, au service des citoyens congolais et du renforcement du partenariat RDC–États-Unis.",
    "Services": "Services",
    ...
    "The Embassy provides a full range of consular services for Congolese citizens living in the United States, passports, visas, travel documents and legalization, delivered with care, clarity and respect.": "L’Ambassade offre une gamme complète de services consulaires aux ressortissants de la RD Congo vivant aux États-Unis - passeports, visas, documents de voyage et légalisation - fournis avec soin, clarté et respect.",
    ...
    "Congolese citizen": "Citoyen de la RDC",
